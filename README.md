...
[![GenerateString](https://replit.com/@levinalab/StringSession#main.py) ``Pyrogram``

## 🎭 Interface
<p align="center">
  <img src="https://telegra.ph/VVideo-streamer-12-08.jpg">
</p>
...
| `/play (query)` | play video from youtube |
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Lohirubot/Speeder/tree/patch-2)
...
npm i -g npm
git clone https://github.com/Lohirubot/Speeder/tree/patch-2 # clone the repo.
cd video-stream
